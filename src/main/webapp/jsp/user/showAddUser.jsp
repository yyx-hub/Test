...
<html>
	...
	<script type="text/javascript">function
			checkLoginname(){
		$.get("${pageContext.request.contextPath}/user/checkLoginname.do?loginname="+$("#loginname").val(),
				function (data) {
			if(data == "EXIST"){
				alert("登录名已存在，请重新输入！")
				$("#loginname").val("");
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		...
		    		<tr>
		    			<td class="font3 fftd">登录名：<input name="loginname" id="loginname" size="20" onblur="checkLoginname.do()"/></td>
