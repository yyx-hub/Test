	    			   ...
	    			   $.ligerDialog.confirm("确认要删除吗?","删除员工",function(r){
	    				   if(r){
							   ...
							   //window.location = "${pageContext.request.contextPath}/employee/removeEmployee?ids=" + ids.get();
	    				   		$.get("${pageContext.request.contextPath}/employee/removeEmployee.do?ids="+ids.get(),
										function (data) {
	    				   					if (data == "OK"){
	    				   						alert("选中员工删除成功！！！");
	    				   						window.location.href = "${pageContext.request.contextPath}/employee/findEmployee.do";
											}else {
	    				   						alert("员工删除失败！！！");
				...
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					<td><input type="checkbox" id="box_${stat.index}" value="${employee.id}"></td>
					 <td>${employee.name }</td>
					  ...
					  <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/employee/findEmployeeById.do?id=${employee.id}&pageIndex=${pageModel.pageIndex}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
		  <yyf:pager
				  pageIndex="${pageModel.pageIndex}"
					 ...
					 submitUrl="${pageContext.request.contextPath}/employee/findEmployee.do?pageIndex={0}&dept_id=${employee.dept.id}
