...
// 					!/^\d{4}-\d{2}-\d{2}$/.test($.trim(birthday.val()))
			...
			$.post("${pageContext.request.contextPath}/employee/addEmployee.do",
				...
				if (data == "FAIL"){
					...
					alert("员工信息添加成功");
					window.location.href = "${pageContext.request.contextPath}/employee/findEmployee.do?pageIndex="+data;
				}
