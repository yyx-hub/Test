	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="empform" method="post" id="empform" action="${pageContext.request.contextPath}/user/findUser.do">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
		    ...
		    <tr class="main_trbg_tit" align="center">
			  ...
			  <c:forEach items="${users}" var="user">
				  <tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					  ...
					  <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/user/modifyUser.do?id=${user.id}&pageIndex=${pageModel.pageIndex}">
